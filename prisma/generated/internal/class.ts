...
/**
   ...
   * `prisma.fundAccount`: Exposes CRUD operations for the **FundAccount** model.
    ...
    * ```
    */
  get fundAccount(): Prisma.FundAccountDelegate<ExtArgs, { omit: OmitOpts }>;
