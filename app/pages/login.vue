...
<template>
  ...
  <div :class="[
    ...
    <div class="fixed top-2 right-2 flex items-center gap-2 z-50">
      ...
      <button @click="toDocumentation()" :class="[
        'p-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg',
        isDark
        ...
        <div :class="[
          ...
          <form @submit.prevent="login" class="space-y-4">
            ...
            <div>
              ...
              <p v-if="loginFormErrors.username" :class="[
                'mt-1 text-sm',
            ...
            <div>
              <div class="relative">
                ...
                <button type="button" @click="lookLoginPS = !lookLoginPS" :class="[
              ...
              <p v-if="loginFormErrors.password" :class="[
                'mt-1 text-sm',
                isDark ? 'text-red-400' : 'text-red-600',
              ]">
                {{ loginFormErrors.password }}
      ...
      <div :class="[
        ...
        <div class="p-2">
          ...
          <form @submit.prevent="register" class="space-y-4">
            ...
            <!-- 账号 -->
            <div>
              <label for="register-username" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                账号 *
              </label>
              <input id="register-username" v-model="registerParam.username" type="text" name="username" :class="[
                ...
                placeholder="请输入账号" />
              <p v-if="registerFormErrors.username" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ registerFormErrors.username }}
              </p>
            </div>
            ...
            <div>
              ...
              <p v-if="registerFormErrors.password" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ registerFormErrors.password }}
              </p>
            </div>
            ...
            <div>
              ...
              <p v-if="registerFormErrors.againPassword" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ registerFormErrors.againPassword }}
              </p>
            </div>
