<template>
  <div class="setting-container">
    <!-- <el-row :gutter="20">
      ...
      <el-col :span="1.5">
        <v-btn type="primary" @click="setConfirm">确认设置</v-btn>
      </el-col>
      <el-col :span="1.5">
        <v-btn type="danger" @click="()=>{url = ''; changeUrl(); setConfirm()}">清除设置</v-btn>
      </el-col>
    </el-row> -->
    ...
    <el-row :gutter="24">
      ...
      <el-col :span="1.5">
        <v-btn type="primary" @click="confirmTypeRelationChange()">保存修改</v-btn>
      </el-col>
      <el-col :span="1.5">
        <v-btn type="danger" @click="cancelTypeRelationChange()">取消修改</v-btn>
      </el-col>
    </el-row>
  </div>
</template>
